...
public class DonateDetailsController {
    ...
    void checkuser(MouseEvent event) throws SQLException, FileNotFoundException {
        if(checkUserByName()){
            Image image =  new Image(new FileInputStream("C://Users/Abdel/OneDrive/Bureau/JavaGeeks/javaFxProjet/src/main/resources/tn.esprit.javafxproject.img/fort.jpg"));
            found.setImage(image);
            found.setVisible(true);
        }else{
            Image image =  new Image(new FileInputStream("C://Users/Abdel/OneDrive/Bureau/JavaGeeks/javaFxProjet/src/main/resources/tn.esprit.javafxproject.img/faible.jpg"));
            found.setImage(image);
            found.setVisible(true);
        }
