...
public class PdfLoader {
    ...
    public void generatePdf() throws FileNotFoundException, SQLException {
        ...
        for(Don don:dons) {
            ...
            threeColTable2.addCell(new Cell().add(new Paragraph(don.getEmoji().getNomEmoji())).setBorder(Border.NO_BORDER));
            threeColTable2.addCell(new Cell().add(new Paragraph(Integer.toString(don.getEmoji().getPrix()))).setTextAlignment(TextAlignment.CENTER).setBorder(Border.NO_BORDER));
            threeColTable2.addCell(new Cell().add(new Paragraph(Double.toString(don.getMontant()))).setTextAlignment(TextAlignment.RIGHT).setBorder(Border.NO_BORDER));
        }
